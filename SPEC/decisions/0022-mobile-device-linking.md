# ADR 0022: Mobile device linking and secret storage
...
The mobile key-derivation and crypto substitutes are settled in ADR 0021
...
1. The invariant-#3 adversarial review of the full mobile key-handling surface
   (this ADR plus ADR 0021), explicitly including the not-yet-built desktop QR
