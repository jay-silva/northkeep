...
export interface CatalogEntry {
  ...
  /**
   * Whether this model family is known to speak NATIVE structured tool
   * calling (M10a, ADR 0027). A routing/UI hint, NOT enforcement — the
   * enforcement is the runtime path (a tools-bearing request the endpoint
   * refuses surfaces as TOOLS_UNSUPPORTED, loud per invariant #6). Unset
...
export const BASELINE_CATALOG: readonly CatalogEntry[] = [
  ...
  { id: 'llama3.1', strengths: ['general', 'reasoning'], contextWindow: 128_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'medium', toolCapable: true, sizeGB: 5 },
  { id: 'llama3.3', strengths: ['general', 'reasoning'], contextWindow: 128_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'slow', toolCapable: true, sizeGB: 40 },
  { id: 'qwen2.5-coder', strengths: ['code'], contextWindow: 128_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'medium', toolCapable: true, sizeGB: 5, notes: 'Code-specialized Qwen.' },
  { id: 'qwen2.5', strengths: ['code', 'reasoning', 'general'], contextWindow: 128_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'medium', toolCapable: true, sizeGB: 9 },
  { id: 'qwen3', strengths: ['code', 'reasoning', 'general'], contextWindow: 128_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'medium', toolCapable: true, sizeGB: 9 },
  ...
  { id: 'mistral', strengths: ['quick', 'general'], contextWindow: 32_000, costTier: 'free-local', inputPer1M: 0, outputPer1M: 0, speedTier: 'fast', toolCapable: true, sizeGB: 4 },
  ...
  { id: 'claude-opus', strengths: ['code', 'reasoning', 'long-context', 'creative'], contextWindow: 1_000_000, costTier: 'high', inputPer1M: 15, outputPer1M: 75, speedTier: 'medium', toolCapable: true, notes: 'Frontier-class; strongest all-rounder.' },
  ...
  { id: 'claude-haiku', strengths: ['quick', 'general'], contextWindow: 200_000, costTier: 'low', inputPer1M: 0.8, outputPer1M: 4, speedTier: 'fast', toolCapable: true },
  // --- OpenAI. gpt-5 family (gpt-5.6 sol/terra/luna) + o-series reasoners.
  { id: 'gpt-5', aliases: ['gpt-5.6', 'gpt-5.5'], strengths: ['code', 'reasoning', 'general', 'long-context'], contextWindow: 400_000, costTier: 'high', inputPer1M: 10, outputPer1M: 30, speedTier: 'medium', toolCapable: true, notes: 'Frontier OpenAI generalist.' },
  { id: 'o3', aliases: ['o4-mini', 'o1'], strengths: ['reasoning', 'code'], contextWindow: 200_000, costTier: 'high', inputPer1M: 10, outputPer1M: 40, speedTier: 'slow', toolCapable: true, notes: 'OpenAI o-series deliberate reasoner.' },
  { id: 'gpt-4o-mini', strengths: ['quick', 'general'], contextWindow: 128_000, costTier: 'low', inputPer1M: 0.15, outputPer1M: 0.6, speedTier: 'fast', toolCapable: true },
  { id: 'gpt-4o', strengths: ['general', 'creative', 'code'], contextWindow: 128_000, costTier: 'medium', inputPer1M: 2.5, outputPer1M: 10, speedTier: 'medium', toolCapable: true },
  // --- Google Gemini (OpenAI-compatible endpoint). Longest match wins, so
  // "gemini-3-pro" beats the "gemini" flash family.
  { id: 'gemini-3-pro', strengths: ['code', 'reasoning', 'long-context', 'general'], contextWindow: 1_000_000, costTier: 'high', inputPer1M: 5, outputPer1M: 15, speedTier: 'medium', toolCapable: true, notes: 'Frontier Gemini.' },
  { id: 'gemini', strengths: ['general', 'quick', 'long-context'], contextWindow: 1_000_000, costTier: 'low', inputPer1M: 0.1, outputPer1M: 0.4, speedTier: 'fast', toolCapable: true, notes: 'Gemini Flash: cheap, fast, huge context.' },
  // --- xAI Grok. "grok-4" matches grok-4.5; "grok" catches grok-3/-3-fast.
  { id: 'grok-4', strengths: ['reasoning', 'code', 'general'], contextWindow: 256_000, costTier: 'high', inputPer1M: 3, outputPer1M: 15, speedTier: 'medium', toolCapable: true, notes: 'Frontier Grok.' },
  { id: 'grok', strengths: ['general', 'reasoning'], contextWindow: 131_000, costTier: 'medium', inputPer1M: 2, outputPer1M: 10, speedTier: 'medium', toolCapable: true },
  // --- DeepSeek (hosted chat model; deepseek-r1 above is the local reasoner).
  { id: 'deepseek-chat', strengths: ['general', 'code', 'reasoning'], contextWindow: 128_000, costTier: 'low', inputPer1M: 0.27, outputPer1M: 1.1, speedTier: 'medium', toolCapable: true, notes: 'Cheap, capable hosted generalist.' },
  ...
  { id: 'llama-4', strengths: ['general', 'code', 'reasoning'], contextWindow: 10_000_000, costTier: 'low', inputPer1M: 0.2, outputPer1M: 0.6, speedTier: 'fast', toolCapable: true, notes: 'Hosted Llama 4 (huge context).' },
  { id: 'llama-3.3', strengths: ['general', 'code'], contextWindow: 128_000, costTier: 'low', inputPer1M: 0.13, outputPer1M: 0.4, speedTier: 'medium', toolCapable: true, notes: 'Hosted Llama 3.3 70B.' },
];
